...
maybe the analyst changed their mind and now we want to keep DELFN 50
(Analyst-Identified Outliers) records in the dataset. Let's set DELFN 50 as a 'count and keep' flag. Notice how the 2 samples that were previously removed are now only 'Affected' and not 'Excluded' 
